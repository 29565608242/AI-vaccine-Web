...
def mutate():
    ...
    print(hla, pep)
    mutate_peptides, mutate_data, mutate_attn, positive_mutate_rate = mutation(target_hla=hla, target_peptide=pep,
                                                                               num_group=1, use_RL=True)
    #print(mutate_data)
    #print(mutate_attn)
...
def mutate2():
    ...
    mutate_peptides, mutate_data, mutate_attn, positive_mutate_rate = mutation(target_hla=tcr, target_peptide=pep,
                                                                               num_group=2, use_RL=True)
    result_list = output_processing(mutate_data, mutate_attn)
